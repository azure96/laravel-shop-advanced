...
<script>
  $(document).ready(function () {
    ...
    $('.btn-crowdfunding').click(function () {
      ...
      // 表单中添加一个收货地址的下拉框
      $form.append('<div class="form-group">' + '<label class="control-label col-sm-3">选择地址</label>' + '<div class="col-sm-9">' + '<select class="form-control" name="address_id"><select>' + '</div></div>');
